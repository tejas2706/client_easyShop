                    ...
                    <View style={{ ...styles.RectangleShapeView, width: this.props.cardDimensions.width, height: this.props.cardDimensions.height, backgroundColor: this.props.backgroundColor }}>
                        <View style={styles.textWrapper}>
                            ...
                            {this.props.buttonToShow ?
                                ...
                                <View alignSelf="center">
                                    <NumericInput
                                        value={this.state.productQtyValue}
                                        onChange={value => {
                                            console.log(value, this.state.productQtyValue)
                                            value > this.state.productQtyValue ? this.props.addToCart(this.props.productId) : this.props.removeFromCart(this.props.productId);
                                            this.setState({ productQtyValue: value })
                                        }
                                        }
                                        totalWidth={wp("25%")}
                                        totalHeight={hp("5%")}
                                        ...
                                        minValue={0}
                                        reachMinDecIconStyle={{ display: "none" }}
                                    />
                                </View>
                            }
                        </View>
